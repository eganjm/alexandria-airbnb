    ...
    <div className="scroll-buttons-container">
        ...
        <div className="tabs-container" ref={tabsContainerRef}>
          <Tabs
            ...
            >
            <Tab label="Lock door (pic)" />
            <Tab label="Lock door (video)" />
          </Tabs>
      </div>
      ...
      <TabPanel value={value} index={0}>
        <img src='images/smartlock_lock.png' style={{width: '35%',height:'auto'}}></img>
      </TabPanel>
      <TabPanel value={value} index={1}>
        <video className="video" width="100%" controls style={{width: '35%',height:'auto'}}>
          <source src="vids/door-lock.mp4" type="video/mp4" />
